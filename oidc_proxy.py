...
class OidcAccessToken(AccessToken):
    id_token: str

class OidcOAuthProxy(OAuthProvider, ConsentMixin):
    ...
    async def load_access_token(self, token: str) -> AccessToken | None:  # type: ignore[override]  # ty:ignore[invalid-method-override]
        ...
        try:
            ...
            validated = OidcAccessToken(**validated.model_dump(), id_token=upstream_token_set.raw_token_data.get("id_token"))
